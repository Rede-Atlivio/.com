...
function escutarMeusChamados() {
    ...
    onSnapshot(q, (snap) => {
        ...
        if (pedidoPendente) {
            ...
            if (isOnline) { containerRadar.innerHTML = `<div id="status-msg" class="text-gray-400 mb-4 py-10"><p class="text-6xl mb-4 animate-pulse">📡</p><p class="font-bold text-lg text-green-500">Buscando Clientes...</p><p class="text-xs text-gray-400 mt-2">Mantenha o app aberto.<br>Atuando em: ${meusServicos.map(s=>s.category).join(', ')}</p></div>`; } 
