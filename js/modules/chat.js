...
export async function abrirChatPedido(orderId) {
    ...
    if (!painelChat || painelChat.parentElement !== document.body) {
        ...
        const stylePC = "width: 450px; height: 600px; max-height: 85vh; right: 20px; bottom: 20px; border-radius: 20px; border: 1px solid #e2e8f0; box-shadow: 0 20px 25px -5px rgb(0 0 0 / 0.1); display: flex; flex-direction: column; overflow: hidden; position: fixed;";
