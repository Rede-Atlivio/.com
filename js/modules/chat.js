                    ...
                    <div class="flex flex-col items-end gap-1 flex-shrink-0">
                        <div class="flex items-center gap-2">
                            ...
                            ${(step < 3 || step === 4) && pedido.status !== 'dispute' ? 
                                `<button onclick="window.confirmarEncerramentoChat('${orderId}')" class="text-[9px] font-black text-gray-400 hover:text-red-500 bg-gray-50 px-2 py-1.5 rounded-lg border border-gray-100 transition uppercase tracking-tighter italic">Encerrar ✋</button>` : 
                                `<span class="text-[8px] font-bold text-amber-600 bg-amber-50 px-2 py-1 rounded border border-amber-200">🔒 ATIVO</span>`
                            }
                        </div>
                    </div>
                </div>
