        ...
        if(currentType === 'users') {
            ...
            tbody.innerHTML += `
                <tr class="border-b border-white/5 hover:bg-white/5 transition group">
                    ...
                    <td class="p-3"><div class="flex items-center gap-2">${statusBadge}<span class="text-emerald-400 font-mono text-xs">R$ ${(data.wallet_balance||data.saldo||0).toFixed(2)}</span></div></td>
